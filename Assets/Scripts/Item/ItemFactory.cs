...
#pragma warning disable IDE0028
        ...
        list.Add(new EquipableData("shield", "Shield", 50, ES.Offhand, new Trait[] { new Trait(CF.PhysDefenseId, 5, TO.Addition), new Trait(CF.PhysEvadeRateId, 10, TO.Addition), new Trait(CF.MagEvadeRateId, 10, TO.Addition), new Trait(CF.PhysDefMultiplierId, 1, TO.Addition), new Trait(CF.MagDefMultiplierId, 1, TO.Addition) }, "A shield."));
        list.Add(new EquipableData("helmet", "Helmet", 50, ES.Head, new Trait[] { new Trait(CF.PhysDefenseId, 5, TO.Addition), new Trait(CF.PhysEvadeRateId, 2, TO.Addition), new Trait(CF.MagDefenseId, -2, TO.Addition) }, "A helmet."));
        list.Add(new EquipableData("chestArmor", "Chest Armor", 100, ES.Body, new Trait[] { new Trait(CF.PhysDefenseId, 10, TO.Addition), new Trait(CF.PhysEvadeRateId, -1, TO.Addition), new Trait(CF.MagDefenseId, -5, TO.Addition), new Trait(CF.MagEvadeRateId, -1, TO.Addition) }, "A chest armor."));
        list.Add(new EquipableData("robe", "Robe", 100, ES.Body, new Trait[] { new Trait(CF.PhysEvadeRateId, 5, TO.Addition), new Trait(CF.MagDefenseId, 10, TO.Addition), new Trait(CF.MagEvadeRateId, 5, TO.Addition) }, "A robe."));
        list.Add(new EquipableData("boots", "Boots", 50, ES.Feet, new Trait[] { new Trait(CF.PhysDefenseId, 4, TO.Addition), new Trait(CF.PhysEvadeRateId, 3, TO.Addition), new Trait(CF.MagDefenseId, 2, TO.Addition), new Trait(CF.MagEvadeRateId, 3, TO.Addition) }, "Boots."));
