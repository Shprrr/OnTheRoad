...
public static class SkillFactory
{
    private static readonly SkillData[] datas = new SkillData[]
    {
        ...
        new SkillData("explosion", "Explosion", 1, "AnimationAttack6", Cursor.POSSIBLE_TARGETS_ALL, new DamagePhysicalEffect(80, false), "Explosion itself to deal damage to everyone."),
